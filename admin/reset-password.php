...
<body>
  ...
  <div class="container" style="padding:40px">
    <div class="row">
      ...
      <div class="col-md-8">
        <h2 class="display-4 text-center">Enter Your Valid Email to Reset your Password</h2>
        <form action="" method="post">
          ...
          <button type="submit" class="btn btn-success btn-lg bg-dark" name="submit">Send Code</button>
        ...
        if (isset($_POST['submit'])) {
          ...
          $query = "insert into otp_admins (otp)values('$OTP')";
