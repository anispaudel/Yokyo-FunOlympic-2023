<!doctype html>
  ...
  <div class="container" style="padding:40px">
    <div class="row">
      ...
      <div class="col-md-6">
        <h2 class="display-4">Sign up to Admin</h2>
        <form action="" method="post">
          ...
          <button type="submit" class="btn btn-success btn-lg bg-dark" name="submit">Create New Account</button>
          <button type="reset" class="btn btn-danger btn-lg">Cancel</button>
          <a href="index.php" class="btn btn-primary btn-lg btn-block bg-dark" style="margin:10px 0px">Log in</a>
        </form>
        <?php
