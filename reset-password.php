...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
    <a class="navbar-brand" href="#">FunOlympic 2023</a>
  ...
  <div class="container" style="padding:40px">
    <div class="row">
      ...
      <div class="col-md-10">
        <h2 class="display-4">Enter your valid mail id to reset your password.</h2>
        ...
        if (isset($_POST['submit'])) {
          ...
          $query = "insert into otp_users (otp)values('$OTP')";
