                    ...
                    <div class="card bg-dark text-white" style="border-radius: 1rem;">
                        <div class="card-body p-5">
                            <div class="mb-md-5 mt-md-4 pb-5">
                                <h2 class="fw-bold mb-2 text-uppercase text-center">User Login</h2>
                                ...
                                <form method="post">
                                    ...
                                    <button class="btn btn-outline-light btn-lg px-5" type="submit" name="submit">Login</button><br>
                                    <br>
                                    <p class="mb-0">Forgot Password? <a href="reset-password.php" class="text-white-50 fw-bold">Click Here!</a></p>
                                    <br>

                                    <p class="mb-0">Don't have an account? <a href="user-signup.php" class="text-white-50 fw-bold">Sign Up</a></p>
                                </form>
                                <?php
