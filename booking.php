...
<body>
  ...
  <div class="jumbotron jumbotron-fluid">
    <div class="container">
      <h1 class="display-3">Book your Ticket</h1>
      <hr class="my-2">
    </div>
  </div>
  <!-- welcome end -->
    ...
    <div class="row">
      <div class="col-md-9">
        <form action="" method="post">
          ...
          <button type="submit" class="btn btn-success btn-lg" name="submit">Book Now</button>
        ...
        if (isset($_POST['submit'])) {
          ...
          $g = $_POST['game'];
          $h = $_POST['country'];
          $query = "insert into ticket_booking(first_name, last_name, gender, address, phone, email, game, country)values('$a','$b','$c','$d','$e','$f','$g','$h')";
      ...
      <div class="col-md-3">
        <img src="assets/games/badminton.jpg" alt="badminton image" class="img-thumbnail">
        <img src="assets/games/chess.jpg" alt="add" class="img-thumbnail">
        <img src="assets/games/tennis.jpg" alt="add" class="img-thumbnail">
        <img src="assets/games/swimming.jpg" alt="add" class="img-thumbnail">
        <img src="assets/games/stadium.jpg" alt="add" class="img-thumbnail">
