  ...
  <div class="container" style="padding: 40px;">
    <div class="row">
      <div class="col-md-9">
        ...
        <h2 class="display-4">Send feedback</h2>
        <form action="" method="post">

          <div class="form-group">
            <label for="fname">Full Name:</label>
            <input type="text" name="fname" id="to" class="form-control" placeholder="Full Name" aria-describedby="helpId">
            <small id="helpId" class="text-muted">Your full name e.g Rose Shrestha</small>
          </div>

          <div class="form-group">
            <label for="sub">Subject:</label>
            <input type="text" name="sub" id="sub" class="form-control" placeholder="Subject" aria-describedby="helpId">
            <small id="helpId" class="text-muted">Subject e.g. Hello</small>
          </div>

          <div class="form-group">
            <label for="msg">Message:</label>
            <textarea class="form-control" name="message" id="message" rows="3" placeholder="Your message goes here"></textarea>
          </div>
